...
const auditRouter = require("./routers/audit_router");
const expenseRouter = require("./routers/expenses_router");
const accountingRouter = require("./routers/accounting_router");
// Load env
dotenv.config();
