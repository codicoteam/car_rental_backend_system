...
const PromoCodeSchema = new Schema(
  {
    ...
    currency: { type: String, enum: ["USD","ZWL"], required: function(){return this.type==="fixed";} },
    ...
    constraints: {
      allowed_classes: [{ type: String, enum: ["economy","compact","midsize","suv","luxury","van","truck"] }],
